...
export class Quiz {
    ...
    static create(props: {
        ...
        if (props.parentProfileId <= 0) throw new Error('INVALID_PARENT_PROFILE_ID');
    ...
    getParentProfileId(): number { return this._parentProfileId; }
    getQuestion(): string { return this._question; }
    getAnswer(): string { return this._answer; }
    getPublishDate(): PublishDate { return this._publishDate; }
    getHint(): string | null { return this._hint; }
    getReward(): string | null { return this._reward; }
}

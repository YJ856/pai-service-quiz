...
export class ParentsGrantRewardMapper {
    toCommand(quizId: string, childProfileId: number, dto: ParentsGrantRewardRequestDto): ParentsGrantRewardCommand {
    ...
    toResponse(result: ParentsGrantRewardResponseResult): ParentsGrantRewardResponseData {
        return {

...
export interface ProfileDirectoryPort {
   ...
   * - 없으면 null
   */
  getParentProfile(parentProfileId: bigint): Promise<ParentProfileSummary | null>;
   ...
   */
  getChildProfiles(childProfileIds: bigint[]): Promise<Record<string, ChildProfileSummary>>;
}
